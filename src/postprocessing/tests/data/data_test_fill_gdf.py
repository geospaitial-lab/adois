...
gdf_buildings['class'] = [1]

gdf_surfaces = gpd.GeoDataFrame(geometry=[polygon], crs='EPSG:25832')
gdf_surfaces['class'] = [2]
...
filled_gdf_buildings_1['class'] = [1]
filled_gdf_buildings_10 = gpd.GeoDataFrame(geometry=[filled_polygon_buildings_10], crs='EPSG:25832')
filled_gdf_buildings_10['class'] = [1]

filled_polygon_surfaces_1 = Polygon(polygon_exterior_coordinates,
                                    holes=[list(polygon_interior.exterior.coords) for polygon_interior in
                                           polygons_interior if polygon_interior.area >= 1])
filled_polygon_surfaces_10 = Polygon(polygon_exterior_coordinates,
                                     holes=[list(polygon_interior.exterior.coords) for polygon_interior in
                                            polygons_interior if polygon_interior.area >= 10])

filled_gdf_surfaces_1 = gpd.GeoDataFrame(geometry=[filled_polygon_surfaces_1], crs='EPSG:25832')
filled_gdf_surfaces_1['class'] = [2]
filled_gdf_surfaces_10 = gpd.GeoDataFrame(geometry=[filled_polygon_surfaces_10], crs='EPSG:25832')
filled_gdf_surfaces_10['class'] = [2]
...
filled_gdf_1 = gpd.GeoDataFrame(geometry=[shapely.affinity.affine_transform(filled_polygon_buildings_1,
                                          ...
                                          shapely.affinity.affine_transform(filled_polygon_surfaces_1,
                                                                            matrix=[1., 0., 0., 1., 14.25, 0.])],
                                crs='EPSG:25832')
filled_gdf_1['class'] = [1, 2]
filled_gdf_10 = gpd.GeoDataFrame(geometry=[shapely.affinity.affine_transform(filled_polygon_buildings_10,
                                                                             matrix=[1., 0., 0., 1., -14.25, 0.]),
                                           shapely.affinity.affine_transform(filled_polygon_surfaces_10,
                                                                             matrix=[1., 0., 0., 1., 14.25, 0.])],
                                 crs='EPSG:25832')
filled_gdf_10['class'] = [1, 2]
...
parameters_fill_gdf = [((gdf_buildings, 0), gdf_buildings),
                       ...
                       ((gdf_surfaces, 0), gdf_surfaces),
                       ((gdf_surfaces, 1), filled_gdf_surfaces_1),
                       ((gdf_surfaces, 10), filled_gdf_surfaces_10),
                       ((gdf, 0), gdf),
                       ((gdf, 1), filled_gdf_1),
